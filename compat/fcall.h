...
#define	GBIT16(p)	((ushort)((uchar*)(p))[0]|((ushort)((uchar*)(p))[1]<<8))
#define	GBIT32(p)	((ulong)((uchar*)(p))[0]|((ulong)((uchar*)(p))[1]<<8)|\
				((ulong)((uchar*)(p))[2]<<16)|((ulong)((uchar*)(p))[3]<<24))
#define	GBIT64(p)	(GBIT32(p)|(uvlong)GBIT32(p+4)<<32)
